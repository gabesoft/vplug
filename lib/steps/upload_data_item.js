...
var request  = require('request')
  ...
  , vimfiles = [ '.vim', 'dotfiles', 'dotvim', 'dotvimfile', 'dotvimrc', 'localvimrc', 'my-vim', 'my_vim', 'myvim', 'myvimcolors', 'myvimplug', 'myvimplug', 'personal-vim', 'vim', 'vim-config', 'vim-setup' 'vim_config', 'vimfiles', 'vimrc' ]
  , chalk    = require('chalk');
